...
-- SAFETY: Drop conflicting core tables if they exist
CREATE EXTENSION IF NOT EXISTS "pgcrypto";

-- Drop in dependency-safe order using CASCADE
...
-- índices para busca por localização e especialidade
...
-- Trigger to keep updated_at fresh if helper exists
DO $$
BEGIN
  IF EXISTS (
...
-- índice para joins rápidos paciente → perfil
...
-- índices para agenda do médico/paciente
...
-- índices para financeiro e auditoria
...
-- índice para gráficos do paciente
...
-- =========================================
-- Perfis (geralmente gerenciado por fluxo de onboarding; políticas serão ajustadas quando RLS ativado)
