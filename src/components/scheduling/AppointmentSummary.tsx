...
export const AppointmentSummary = ({
  ...
  selectedPatientName
    ...
    const locationText = selectedLocal?.nome_local || null;
    const locationAddress = selectedLocal?.endereco ? 
        `${selectedLocal.endereco.logradouro}, ${selectedLocal.endereco.numero} - ${selectedLocal.endereco.bairro}, ${selectedLocal.endereco.cidade}/${selectedLocal.endereco.uf}` : null;
