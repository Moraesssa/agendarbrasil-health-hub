import { ArrowLeft, Loader2, Calendar, MapPin, Search } from "lucide-react";
            ...
            <SidebarInset className="flex-1">
                <header className="sticky top-0 z-40 flex h-16 shrink-0 items-center gap-2 border-b border-blue-100/50 bg-white/95 backdrop-blur-md shadow-sm px-6">
                    ...
                    <div className="flex-1">
                        ...
                        <p className="text-sm text-gray-600">Encontre o profissional ideal para você.</p>
                    </div>
                </header>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
                        <div className="lg:col-span-2">
                            <Card className="shadow-xl">
                                <CardHeader>
                                    <CardTitle>Filtros e Agendamento</CardTitle>
                                    <CardDescription>Siga os passos para encontrar um horário.</CardDescription>
                                </CardHeader>
                                <CardContent className="space-y-8">
                                    {/* --- ETAPA 1: ESPECIALIDADE E LOCALIZAÇÃO --- */}
                                    {/* Este é o contêiner que deve ter 3 colunas em telas médias */}
                                    ...
                                    {/* Este contêiner deve ter 2 colunas em telas médias */}
