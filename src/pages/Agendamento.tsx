...
const Agendamento = () => {
  ...
  // Renomeado para 'hooks' para facilitar a passagem de todas as props para o Resumo
    ...
    <div className="min-h-screen bg-gray-50/50">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
          {/* Coluna Principal do Formulário (Esquerda) */}
          <div className="lg:col-span-2">
            <Card className="shadow-lg border-gray-200 rounded-xl">
              ...
              <CardContent className="space-y-6 p-6 pt-0">
                ...
                {/* Divisor para separar os filtros da seleção de data/hora */}
                {hooks.selectedDoctor && <hr className="my-2 border-gray-200" />}
                ...
                <Button 
                  ...
                  className="w-full bg-blue-600 hover:bg-blue-700 text-lg py-6 rounded-lg shadow-md transition-transform transform hover:scale-105" 
