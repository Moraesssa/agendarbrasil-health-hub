...
-- Step 1: Create all necessary ENUM types as defined in schema.sql
CREATE TYPE IF NOT EXISTS tipo_usuario AS ENUM ('paciente', 'medico', 'admin');
CREATE TYPE IF NOT EXISTS tipo_consulta AS ENUM ('presencial', 'teleconsulta');
CREATE TYPE IF NOT EXISTS status_consulta AS ENUM ('agendada', 'confirmada', 'realizada', 'cancelada', 'nao_compareceu');
CREATE TYPE IF NOT EXISTS tipo_documento AS ENUM ('prescricao', 'atestado', 'pedido_exame');
